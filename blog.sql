...
INSERT INTO `users` (`id`, `name`, `email`, `phone_no`, `password`, `remember_me`, `status`, `created_at`) VALUES
(5, 'Oluwatomi Ayobami', 'tomi@blog.com', '08094219571', '$2y$10$0Al2aSmTv3n3.E0sq.ZMseQ0aaZsjsi6Nl8AW5Qx.FWxrR.hq2oh2', NULL, 1, '2021-03-11 07:24:42');
...
INSERT INTO `visits` (`id`, `total_count`) VALUES
(1, 9);
COMMIT;
