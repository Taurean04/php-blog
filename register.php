          ...
          <div class="card shadow-lg p-3 mb-5 bg-white rounded">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-xl-12 col-lg-12 mt-4">
              <div class="form-group">
                ...
                <input type="text" id="inputPhone" class="form-control" placeholder="Enter Phone" name="phone_no" required autofocus value="<?php if (isset($_POST['phone_no'])) echo $_POST['phone_no'] ?>">
                <?php if (isset($Response['phone_no']) && !empty($Response['phone_no'])): ?>
                  <small class="text-danger"><?php echo $Response['phone_no']; ?></small>
                <?php endif; ?>
              </div>
            </div>
            ...
            <p class="mt-5 text-center mb-3 text-muted">&copy; <?php echo date('Y'); ?></p>
          </form>
          </div>
        </div>
      </div>
